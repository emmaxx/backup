  ...
  render() {
    return (
      <Content>
        <TitleUpdater title="" />
        <div className="title">
          <h1>Professional resources for product teams</h1>
        </div>
        <div className="subtitle">
          <h5>Create awesome projects faster and more accurately with wireframes,<br /> iOS and Android templates and other useful products.</h5>
          {this.makeSearch()}
        </div>
